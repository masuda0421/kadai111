...
scene.onOverlapTile(SpriteKind.Player, assets.tile`kabe3`, function (sprite, location) {
    if (ikikaeri == 0) {
        ...
        tiles.placeOnTile(mySprite2, tiles.getTileLocation(9, 7))
    } else {
        scene.setBackgroundImage(img`
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`mizu-ido`, function (sprite, location) {
    if (controller.A.isPressed()) {
        tiles.setTilemap(tilemap`mizuba`)
        mySprite.setPosition(120, 105)
        mySprite2.destroy()
        idou = 1
        pause(200)
    }
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`deiri`, function (sprite, location) {
    if (controller.A.isPressed()) {
        ...
        if (idou == 1) {
            ...
            mySprite.setPosition(152, 120)
            idou = 0
            pause(200)
        } else if (idou == 3) {
            mySprite.setPosition(320, 120)
            idou = 0
            pause(200)
        } else if (idou == 4) {
            mySprite.setPosition(255, 40)
            idou = 0
            pause(200)
        }
    }
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`deguti-ido`, function (sprite, location) {
    if (lastKey == 1) {
        scene.setBackgroundImage(img`
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`osu-basyo`, function (sprite, location) {
